...
function BlogCard({ blog }) {
  ...
  return (
    <div
      ...
      className={`relative aspect-video rounded-lg overflow-hidden shadow hover:scale-105 duration-300 cursor-pointer ${
        darkMode ? "hover:shadow-neutral-400/15" : "hover:shadow-black"
      }`}
    >
